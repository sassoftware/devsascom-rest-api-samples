...
subsequent API calls. Access tokens are obtained when a client requests and authenticates to the SAS Logon API with a valid form of authorization,
...
Here is an example of a client application obtaining an access token using its client credentials.
...
Here is an example of a client application obtaining an access token for an end user by providing the user's password credentials.
...
Here is an example of performing a GET request to list clients.
```
...
Here is an example of performing a GET request to retrieve clients.
...
Here is an example of performing a POST request to create a client.
...
Here is an example of performing a PUT request to list clients.
...
Here is an example of performing a PUT request to change a secret.
...
Here is an example of deleting a client.
...
Here is an example of using a consul ACL token to obtain an OAuth access token. The OAuth access token can be used to create a new client.
