...
* [Discover top-level links for the Annotations API](#top-level-links)
* [Create a new annotation](#create-annotation)
* [Add an associated object (member) to an annotation](#create-member)
* [Get annotations by associated resource URIs](#get-by-resourceuris)
* [Get members by associated annotation IDs](#get-members-by-annotation-ids)

#### <a name='top-level-links'>Discover Top-Level Links for the Annotations API</a>
...
#### <a name='get-by-resourceuris'>Get Annotations by Associated Resource URIs</a>
...
version 2, last updated 25 Nov, 2019