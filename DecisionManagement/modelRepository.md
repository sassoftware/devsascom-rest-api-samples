...
For more information, see the [SAS Model Manager software product page](https://support.sas.com/en/software/model-manager-support.html).
...
In this example, the analytic stores of the referenced model are copied from the ModelStore CAS library to the /opt/sas/viya/config/data/modelsvr/astore directory. 
...
<br>
version 2, last updated 25 Jun, 2019