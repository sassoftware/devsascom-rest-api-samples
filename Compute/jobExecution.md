...
The root resource can be used by an administrative program to use a Hypermedia As The Engine Of Application State (HATEOAS) approach. Use this approach to find the links to list jobs, list job requests, and execute jobs.
...
#### <a name='GetJobsList'>Get a List of Jobs</a>
...
#### <a name='SubmitJobDefinition'> a Job Definition for Execution</a>
...
the requested is created by the hypothetical "jobrequestui" webapp.
